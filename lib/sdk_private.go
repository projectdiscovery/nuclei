...
func (e *NucleiEngine) applyRequiredDefaults(ctx context.Context) {
	...
	if e.honeypotCache == nil && e.opts.MaxHostMatch > 0 && !e.opts.NoHoneypot {
		e.honeypotCache = honeypotcache.New(e.opts.MaxHostMatch, honeypotcache.DefaultMaxHostsCount)
	}
	// setup interactsh
