...
func New(options *types.Options) (*Runner, error) {
	...
	outputWriter, err := output.NewStandardWriter(!options.NoColor, options.NoMeta, options.NoTimestamp, options.JSON, options.JSONRequests, options.MatchedStatus, options.Output, options.TraceLogFile, options.ErrorLogFile)
	if err != nil {
