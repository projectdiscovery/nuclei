...
type Executer interface {
	...
	Execute(input string, params map[string]interface{}) (bool, error)
	// ExecuteWithResults executes the protocol requests and returns results instead of writing them.
	ExecuteWithResults(input string, params map[string]interface{}, callback OutputEventCallback) error
}
