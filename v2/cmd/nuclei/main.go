...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("cloud", "Cloud",
		...
		flagSet.BoolVarP(&options.ListReportingSources, "get-reporting-sources", "lrs", false, "get reporting sources"),
		...
		flagSet.StringVarP(&options.DisableReportingSource, "disable-reportingsource", "dirs", "", "disable specified reporting source"),
		flagSet.StringVarP(&options.EnableReportingSource, "enable-reportingsource", "enrs", "", "disable specified reporting source"),
