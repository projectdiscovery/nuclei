...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("cloud", "Cloud",
		...
		flagSet.StringVarEnv(&options.CloudAPIKey, "cloud-api-key", "ak", "", "NUCLEI_CLOUD_API", "api-key for the nuclei cloud server (NUCLEI_CLOUD_API)"),
		flagSet.BoolVarP(&options.NoStore, "no-store", "nos", false, "disable scan storage on cloud"),
		flagSet.StringVarP(&options.ScanOutput, "scan-output", "sno", "", "display scan output by id"),
