...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("input", "Target",
		...
		flagSet.StringSliceVarP(&options.ExcludeTargets, "exclude-targets", "etg", nil, "hosts to exclude to scan from the input list (ip, cidr, hostname)", goflags.FileCommaSeparatedStringSliceOptions),
