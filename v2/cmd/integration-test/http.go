...
var httpTestcases = []TestCaseInfo{
	...
	{DisableOn: nil, Path: "http/get-headers.yaml", TestCase: &httpGetHeaders{}},
	{DisableOn: nil, Path: "http/get-query-string.yaml", TestCase: &httpGetQueryString{}},
	{DisableOn: nil, Path: "http/get-redirects.yaml", TestCase: &httpGetRedirects{}},
	{DisableOn: nil, Path: "http/get-host-redirects.yaml", TestCase: &httpGetHostRedirects{}},
	{DisableOn: nil, Path: "http/disable-redirects.yaml", TestCase: &httpDisableRedirects{}},
	{DisableOn: nil, Path: "http/get.yaml", TestCase: &httpGet{}},
	{DisableOn: nil, Path: "http/post-body.yaml", TestCase: &httpPostBody{}},
	{DisableOn: nil, Path: "http/post-json-body.yaml", TestCase: &httpPostJSONBody{}},
	{DisableOn: nil, Path: "http/post-multipart-body.yaml", TestCase: &httpPostMultipartBody{}},
	{DisableOn: nil, Path: "http/raw-cookie-reuse.yaml", TestCase: &httpRawCookieReuse{}},
	{DisableOn: nil, Path: "http/raw-dynamic-extractor.yaml", TestCase: &httpRawDynamicExtractor{}},
	{DisableOn: nil, Path: "http/raw-get-query.yaml", TestCase: &httpRawGetQuery{}},
	{DisableOn: nil, Path: "http/raw-get.yaml", TestCase: &httpRawGet{}},
	{DisableOn: nil, Path: "http/raw-with-params.yaml", TestCase: &httpRawWithParams{}},
	{DisableOn: nil, Path: "http/raw-unsafe-with-params.yaml", TestCase: &httpRawWithParams{}}, // Not a typo, functionality is same as above
	{DisableOn: nil, Path: "http/raw-path-trailing-slash.yaml", TestCase: &httpRawPathTrailingSlash{}},
	{DisableOn: nil, Path: "http/raw-payload.yaml", TestCase: &httpRawPayload{}},
	{DisableOn: nil, Path: "http/raw-post-body.yaml", TestCase: &httpRawPostBody{}},
	{DisableOn: nil, Path: "http/raw-unsafe-path.yaml", TestCase: &httpRawUnsafePath{}},
	{DisableOn: nil, Path: "http/http-paths.yaml", TestCase: &httpPaths{}},
	{DisableOn: nil, Path: "http/request-condition.yaml", TestCase: &httpRequestCondition{}},
	{DisableOn: nil, Path: "http/request-condition-new.yaml", TestCase: &httpRequestCondition{}},
	{DisableOn: nil, Path: "http/self-contained.yaml", TestCase: &httpRequestSelfContained{}},
	{DisableOn: nil, Path: "http/self-contained-with-path.yaml", TestCase: &httpRequestSelfContained{}}, // Not a typo, functionality is same as above
	{DisableOn: nil, Path: "http/self-contained-with-params.yaml", TestCase: &httpRequestSelfContainedWithParams{}},
	{DisableOn: nil, Path: "http/self-contained-file-input.yaml", TestCase: &httpRequestSelfContainedFileInput{}},
	{DisableOn: nil, Path: "http/get-case-insensitive.yaml", TestCase: &httpGetCaseInsensitive{}},
	{DisableOn: nil, Path: "http/get.yaml,http/get-case-insensitive.yaml", TestCase: &httpGetCaseInsensitiveCluster{}},
	{DisableOn: nil, Path: "http/get-redirects-chain-headers.yaml", TestCase: &httpGetRedirectsChainHeaders{}},
	{DisableOn: nil, Path: "http/dsl-matcher-variable.yaml", TestCase: &httpDSLVariable{}},
	{DisableOn: nil, Path: "http/dsl-functions.yaml", TestCase: &httpDSLFunctions{}},
	{DisableOn: nil, Path: "http/race-simple.yaml", TestCase: &httpRaceSimple{}},
	{DisableOn: nil, Path: "http/race-multiple.yaml", TestCase: &httpRaceMultiple{}},
	{DisableOn: nil, Path: "http/stop-at-first-match.yaml", TestCase: &httpStopAtFirstMatch{}},
	{DisableOn: nil, Path: "http/stop-at-first-match-with-extractors.yaml", TestCase: &httpStopAtFirstMatchWithExtractors{}},
	{DisableOn: nil, Path: "http/variables.yaml", TestCase: &httpVariables{}},
	{DisableOn: nil, Path: "http/variable-dsl-function.yaml", TestCase: &httpVariableDSLFunction{}},
	{DisableOn: nil, Path: "http/get-override-sni.yaml", TestCase: &httpSniAnnotation{}},
	{DisableOn: nil, Path: "http/get-sni.yaml", TestCase: &customCLISNI{}},
	{DisableOn: nil, Path: "http/redirect-match-url.yaml", TestCase: &httpRedirectMatchURL{}},
	{DisableOn: nil, Path: "http/get-sni-unsafe.yaml", TestCase: &customCLISNIUnsafe{}},
	{DisableOn: nil, Path: "http/annotation-timeout.yaml", TestCase: &annotationTimeout{}},
	{DisableOn: nil, Path: "http/custom-attack-type.yaml", TestCase: &customAttackType{}},
	{DisableOn: nil, Path: "http/get-all-ips.yaml", TestCase: &scanAllIPS{}},
	{DisableOn: nil, Path: "http/get-without-scheme.yaml", TestCase: &httpGetWithoutScheme{}},
	{DisableOn: nil, Path: "http/cl-body-without-header.yaml", TestCase: &httpCLBodyWithoutHeader{}},
	{DisableOn: nil, Path: "http/cl-body-with-header.yaml", TestCase: &httpCLBodyWithHeader{}},
	{DisableOn: nil, Path: "http/save-extractor-values-to-file.yaml", TestCase: &httpSaveExtractorValuesToFile{}},
	{DisableOn: nil, Path: "http/cli-with-constants.yaml", TestCase: &ConstantWithCliVar{}},
	{DisableOn: nil, Path: "http/matcher-status.yaml", TestCase: &matcherStatusTest{}},
	{DisableOn: nil, Path: "http/disable-path-automerge.yaml", TestCase: &httpDisablePathAutomerge{}},
}
