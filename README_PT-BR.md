...
RATE-LIMIT:
   -rl, -rate-limit int               número máximo de solicitações a serem enviadas por segundo (ignorado quando -rate-limit-host está definido) (padrão 150)
   -rld, -rate-limit-duration value   intervalo/janela de recarga para -rate-limit (padrão 1s)
   -rlm, -rate-limit-minute int       número máximo de solicitações a serem enviadas por minuto (OBSOLETO)
   -rlh, -rate-limit-host int         número máximo de solicitações por host por rate-limit-host-duration (0 = desativado, tem prioridade sobre -rate-limit)
   ...
   -prc, -probe-concurrency int       concorrência de sondas http com httpx (padrão 50)
