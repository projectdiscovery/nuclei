...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("optimization", "Optimizations",
		...
		flagSet.IntVarP(&options.HoneypotThreshold, "honeypot-threshold", "hpt", 0, "max unique template matches per host before flagging as potential honeypot (0 = disabled)"),
		flagSet.IntVarP(&options.HoneypotPercentage, "honeypot-percentage", "hpp", 0, "min percentage of total templates matching per host to flag as honeypot (0 = disabled)"),
