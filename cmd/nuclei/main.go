...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("optimization", "Optimizations",
		...
		flagSet.BoolVarP(&options.HoneypotDetection, "honeypot-detection", "hpd", false, "enable honeypot detection to identify hosts matching abnormally high percentage of templates"),
		flagSet.IntVarP(&options.HoneypotThreshold, "honeypot-threshold", "hpt", 50, "honeypot detection threshold percentage (default 50)"),
