...
var interactshTestCases = []TestCaseInfo{
	...
	{Path: "protocols/http/interactsh-with-payloads.yaml", TestCase: &httpInteractshWithPayloadsRequest{}, DisableOn: func() bool { return osutils.IsWindows() || osutils.IsOSX() }},
