...
func init() {
	...
	if err != nil {
		// Updated: Log error and disable all code test cases to avoid misleading failures
	...
	for _, v := range codeTestCases {
		...
		// Updated: Restore log.Fatalf for template signing to preserve fail-fast semantics
