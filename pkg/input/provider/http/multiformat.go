...
func NewHttpInputProvider(inputFile, inputMode string) (*HttpInputProvider, error) {
	...
	return &HttpInputProvider{format: format, inputFile: inputFile, count: count}, nil
}
