...
// of the engine.
func (e *Engine) Execute(templates []*templates.Template, target inputs.InputProvider) *atomic.Bool {
	return e.ExecuteScanWithOpts(templates, target, false)
}

// ExecuteWithResults a list of templates with results
func (e *Engine) ExecuteWithResults(templatesList []*templates.Template, target inputs.InputProvider, callback func(*output.ResultEvent)) *atomic.Bool {
	e.Callback = callback
	return e.ExecuteScanWithOpts(templatesList, target, false)
}

// ExecuteScanWithOpts executes scan with given scanStrategy
func (e *Engine) ExecuteScanWithOpts(templatesList []*templates.Template, target inputs.InputProvider, noCluster bool) *atomic.Bool {
	results := &atomic.Bool{}
...
func (e *Engine) executeTemplateSpray(templatesList []*templates.Template, target inputs.InputProvider) *atomic.Bool {
	results := &atomic.Bool{}
...
func (e *Engine) executeHostSpray(templatesList []*templates.Template, target inputs.InputProvider) *atomic.Bool {
	results := &atomic.Bool{}
