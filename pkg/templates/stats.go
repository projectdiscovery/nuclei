...
func init() {
	...
	stats.NewEntry(ExcludedSelfContainedStats, "Excluded %d self-contained template[s] (disabled as default)")
	stats.NewEntry(ExcludedFileStats, "Excluded %d file template[s] (disabled as default)")
