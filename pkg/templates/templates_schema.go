...
var templateMetadata = []schema.PropertyMetadata{
	...
	},
	{
		PropName: "dns",
		Description: schema.MultiLine(
			"DNS protocol block for sending DNS queries",
			"Example:",
			"```yaml",
			"dns:",
			"  - name: \"{{FQDN}}\"",
	...
	},
	{
		PropName: "tcp",
		Description: schema.MultiLine(
			"TCP/network protocol block for raw socket requests",
			"Example:",
			"```yaml",
			"tcp:",
			"  - host:",
	...
	},
	{
		...
		Deprecated: true,
		Description: schema.MultiLine(
			"Deprecated: use `tcp` instead of `network`",
		),
	},
	{
		PropName: "file",
		Description: schema.MultiLine(
			"File protocol block for matching against local files",
			"Example:",
			"```yaml",
			"file:",
			"  - extensions:",
	...
	},
	{
		PropName: "headless",
		Description: schema.MultiLine(
			"Headless protocol block for browser automation",
			"Example:",
			"```yaml",
			"headless:",
			"  - steps:",
	...
	},
	{
		PropName: "ssl",
		Description: schema.MultiLine(
			"SSL protocol block for TLS certificate / cipher checks",
			"Example:",
			"```yaml",
			"ssl:",
			"  - address: \"{{Host}}:{{Port}}\"",
	...
	},
	{
		PropName: "websocket",
		Description: schema.MultiLine(
			"Websocket protocol block for websocket requests",
		),
	},
	{
		PropName: "whois",
		Description: schema.MultiLine(
			"WHOIS protocol block for domain/IP WHOIS lookups",
			"Example:",
			"```yaml",
			"whois:",
			"  - query: \"{{FQDN}}\"",
	...
	},
	{
		PropName: "code",
		Description: schema.MultiLine(
			"Code protocol block for executing external engines (python, sh, etc.)",
			"Example:",
			"```yaml",
			"code:",
			"  - engine:",
	...
	},
	{
		PropName: "javascript",
		Description: schema.MultiLine(
			"JavaScript protocol block for nuclei JS runtime requests",
			"Example:",
			"```yaml",
			"javascript:",
			"  - code: |",
	...
	},
	{
		PropName: "workflows",
		Description: schema.MultiLine(
			"Workflows define multi-template execution graphs",
			"A workflow template usually only needs `id`, `info`, and `workflows`",
			"Example:",
			"```yaml",
			"workflows:",
