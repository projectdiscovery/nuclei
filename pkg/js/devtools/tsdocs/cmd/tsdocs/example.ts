 ...
 */
export function Open(protocol: string, address: string): NetConn | null {
    return null;
}
...
* @throws {Error} - if the operation fails
 */
export function OpenTLS(protocol: string, address: string): NetConn | null {
    return null;
}
