...
export class Client {
    ...
    public demand(taskName: string, executable: string, args: string, opts?: ExecutionOptions): Result | null { return null; }
    public Demand(taskName: string, executable: string, args: string, opts?: ExecutionOptions): Result | null { return null; }
    public create(taskName: string, executable: string, args: string, opts?: ExecutionOptions): Result | null { return null; }
    public Create(taskName: string, executable: string, args: string, opts?: ExecutionOptions): Result | null { return null; }
}
