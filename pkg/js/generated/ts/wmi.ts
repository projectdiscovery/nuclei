...
export class Client {
    ...
    public SetOptions(opts: ExecutionOptions): void { return; }
    public command(command: string, opts?: ExecutionOptions): Result | null { return null; }
    public Command(command: string, opts?: ExecutionOptions): Result | null { return null; }
    public proc(executable: string, args: string, opts?: ExecutionOptions): Result | null { return null; }
    public Proc(executable: string, args: string, opts?: ExecutionOptions): Result | null { return null; }
    public call(namespace: string, className: string, method: string, argsJSON: string, opts?: ExecutionOptions): Result | null { return null; }
    public Call(namespace: string, className: string, method: string, argsJSON: string, opts?: ExecutionOptions): Result | null { return null; }
}
