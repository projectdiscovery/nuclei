...
type Options struct {
	...
	// the -l flag.
	// ProfileName specifies the name of the template profile
	ProfileName string `yaml:"name,omitempty" json:"name,omitempty"`
	// ProfilePurpose specifies the purpose of the template profile
	ProfilePurpose string `yaml:"purpose,omitempty" json:"purpose,omitempty"`
	// ProfileID specifies the ID of the template profile
	ProfileID string `yaml:"id,omitempty" json:"id,omitempty"`
	// ProfileDescription specifies the description of the template profile
	ProfileDescription string `yaml:"description,omitempty" json:"description,omitempty"`
	// Secrets specifies the secrets to be used for the scan
